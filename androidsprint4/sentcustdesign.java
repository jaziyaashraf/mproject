...
public class User_Sent_customizeddesign extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_useraddcustomizeddesign);
        ...
        url = sh.getString("url", "") + "and_customdesign/";
    ...
    public void onClick(View v) {
        ...
        if(v==im)
        {
            ...
            final ProgressDialog pd = new ProgressDialog(User_Sent_customizeddesign.this);
